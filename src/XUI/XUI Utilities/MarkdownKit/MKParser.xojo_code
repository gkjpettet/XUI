...
Protected Class MKParser
	...
	#tag Method, Flags = &h0, Description = 50617273657320606D61726B646F776E6020696E746F2061204D61726B646F776E20646F63756D656E742E
		Function ParseSource(markdown As String) As MKDocument
		  ...
		  Var lines() As XUITextLine
		  
		  Var iLimit As Integer = tmp.LastIndex
		  Var start As Integer = 0
		  For i As Integer = 0 To iLimit
		    Var line As New XUITextLine(i + 1, start, tmp(i))
		    lines.Add(line)
		    start = line.Finish + 1
		  Next i
	...
	#tag Method, Flags = &h21
		Private Sub Reset(lines() As XUITextLine)
	...
	#tag Property, Flags = &h21, Description = 546865206C696E65207765206172652063757272656E746C792070726F63657373696E672E
		Private mCurrentLine As XUITextLine
	#tag EndProperty
