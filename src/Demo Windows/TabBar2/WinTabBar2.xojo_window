#tag DesktopWindow
Begin DesktopWindow WinTabBar2
   Backdrop        =   0
...
#tag Events TabBar
	...
	#tag Event , Description = 412074616220776173206A75737420616464656420746F2074686520746162206261722061742060696E646578602E
		Sub DidAddTab(tab As XUITabBar2Item, index As Integer)
	...
	#tag Event , Description = 412074616220686173206A757374206265656E2072656D6F7665642066726F6D2074686520746162206261722E
		Sub DidRemoveTab(tab As XUITabBar2Item)
...
#tag Events PopupStyle
	#tag Event
		Sub Opening()
		  Me.AddRow("Safari")
		  Me.RowTagAt(Me.LastAddedRowIndex) = XUITabBar2Style.Safari
	...
	#tag Event
		Sub SelectionChanged(item As DesktopMenuItem)
		  ...
		  Var style As XUITabBar2Style = Me.RowTagAt(Me.SelectedRowIndex)
