...
Begin DemoWindow WinImageButton
   ...
   Begin DesktopCheckBox CheckBoxEnabled
      ...
      Width           =   100
   End
   Begin DesktopButton ButtonDefaultImage
      AllowAutoDeactivate=   True
      Bold            =   False
      Cancel          =   False
      ...
      Width           =   135
   End
   Begin DesktopButton ButtonPressedImage
      AllowAutoDeactivate=   True
      Bold            =   False
      Cancel          =   False
      Caption         =   "Choose..."
      ...
      Width           =   99
   End
   Begin DesktopButton ButtonHoverImage
      AllowAutoDeactivate=   True
      Bold            =   False
      Cancel          =   False
      Caption         =   "Choose..."
      ...
      Width           =   99
   End
   Begin DesktopButton ButtonDisabledImage
      AllowAutoDeactivate=   True
      Bold            =   False
      Cancel          =   False
      Caption         =   "Choose..."
   ...
   Begin DesktopLabel Label1
      ...
      Width           =   492
   End
   Begin DesktopCheckBox CheckBoxHasPressedImage
      AllowAutoDeactivate=   True
      Bold            =   False
      Caption         =   "Has Pressed Image"
      Enabled         =   True
      FontName        =   "System"
      FontSize        =   0.0
      FontUnit        =   0
...
#tag Events CheckBoxHasPressedImage
	...
	#tag EndEvent
#tag EndEvents
#tag Events CheckBoxHasHoverImage
	#tag Event
		Sub ValueChanged()
		  ButtonHoverImage.Enabled = Me.Value
		  
		  If Not Me.Value Then Button.HoverImage = Nil
		End Sub
	#tag EndEvent
#tag EndEvents
#tag Events CheckBoxHasDisabledImage
	#tag Event
		Sub ValueChanged()
		  ButtonDisabledImage.Enabled = Me.Value
		  
		  If Not Me.Value Then Button.DisabledImage = Nil
		End Sub
	#tag EndEvent
#tag EndEvents
