#tag Class
Protected Class NoQuotesTextArea
Inherits DesktopTextArea
	#tag Event
		Sub Opening()
		  // Disable the smart quotes feature on macOS.
		  #If TargetCocoa Then
		    Var myTextArea As Ptr
		    
		    Declare Function documentView Lib "AppKit" Selector "documentView" (obj_id As Ptr) As Ptr
		    
		    myTextArea = documentView(Me.Handle)
		    
		    Declare Sub setAutomaticQuoteSubstitutionEnabled Lib "AppKit" _
